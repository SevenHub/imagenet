...
saveH5FilePath = savePath+'conv1d.h5'
...
#             print(saveH5FilePath)
    ...
    def createModel(self):
        ...
        model = Sequential()
        model.add(Conv1D(64, 3, activation='relu', input_shape=(conf.feature_back_days,6)))
...
#                     print("#######predictions##########")  
        ...
        #         print('Predicted:', predicted )
                    if int(predictions[0][0]) > 0 or int(modelData.train_y[0]) > 0:
                        print("买入")
                        print("#################")
                        print("predictions:",int(predictions[0][0])) 
#                         print("modelData.train_x[0]:",modelData.train_x[0])
                        print("modelData.train_x",modelData.train_x)
                        print("modelData.train_y",modelData.train_y)
                        print("#################")
                if i >10:
                    break    
