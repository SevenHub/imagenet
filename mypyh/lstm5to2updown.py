...
saveH5FilePath = savePath+'lstm5to2updown.h5'
...
#         test_input_aux = []
        ...
        for i in range(0, len(traindata)-conf.feature_back_days-conf.feature_days):
            ...
            c = 0    
            if data['close'][i+conf.feature_days+conf.feature_days]>data['close'][i+conf.feature_back_days+1]:
                c = 1
...
#         modelData.train_x_aux = np.array(train_input_aux)
        c = 0    
        if traindata['close'][conf.feature_back_days+conf.feature_days]>traindata['close'][conf.feature_back_days+1]:
            c = 1 
...
#                     break    
    def test(self):       
        ...
        #         if(i<12):continue/////
                ...
                self.buySell(lstm_model,fileName,"2019/04/01",3)
